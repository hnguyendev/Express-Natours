    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "Update ".concat(type.toUpperCase(), " success!"));
            location.reload('/me');
          }
          _context.next = 11;
          break;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51ND9W3GcUkuZG4gIK6uCR2WIDC3dfTq3Z2J574u9tc0vhQmrx1ru4RbfCZvDGKCru9WWI4gdm4bJm0jH4T2j3e7c00sYHA713M');
...
var updateDataBtn = document.querySelector('.form-user-data');
...
if (updateDataBtn) updateDataBtn.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (updatePasswordBtn) updatePasswordBtn.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          // wait for above to complete then delete form;
